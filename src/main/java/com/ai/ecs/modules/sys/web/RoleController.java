...
import com.ai.ecs.modules.sys.service.SystemService;
...
public class RoleController extends BaseController {
	...
	public String form(Role role, Model model) {
		...
		model.addAttribute("menuList", systemService.findAdminAllMenu());
...
//		}
	...
	public String assign(User user,HttpServletRequest request,HttpServletResponse response, Model model) {
		Page<User> userList = systemService.findUser(new Page<User>(request,response), user);
