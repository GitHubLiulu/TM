...
import com.ai.ecs.modules.sys.service.AreaService;
...
public class AreaController extends BaseController {
	...
	public String pageList(HttpServletRequest request,HttpServletResponse response,Area area,Model model){
		Page<Area> page = new Page<Area>(request, response);
		area.setPage(page);
		page = areaService.findPageList(area);
		model.addAttribute("page", page);
		return "modules/sys/areaPageList";
	}
...
//		}
	...
	public String form1(Area area, Model model) {
		Area obj = areaService.get(area);
		model.addAttribute("area", obj);
		return "modules/sys/areaForm";
	}
	...
	public String save(Area area, Model model, RedirectAttributes redirectAttributes) {
		if(Global.isDemoMode()){
			...
			return "redirect:" + adminPath + "/sys/area/pageList";
		}
