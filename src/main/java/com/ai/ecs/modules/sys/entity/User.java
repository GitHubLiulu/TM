...
import com.ai.ecs.common.utils.excel.fieldtype.RoleListType;
...
public class User extends DataEntity<User> {
	...
	private String roleGrade;//区域角色等级 1：省市管理员 2：地市管理员 3：区县管理员 4：网格（片区）管理员 5：营业厅管理员 7：营业员
	
	private String grade;//sys_office表中数据，标识自营渠道【0】和社会渠道【1】。
	...
	private String uId;//uId:经分工号
	
	private String ssoinfo;//ssoinfo:经分登录加密串数据
	...
	public static boolean isAdmin(String id){
		return id != null && Global.isAdmin.equals(id);
	}
