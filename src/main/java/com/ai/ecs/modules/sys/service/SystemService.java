...
import com.ai.ecs.common.security.Digests;
import com.ai.ecs.common.security.shiro.session.SessionDAO;
import com.ai.ecs.common.service.BaseService;
import com.ai.ecs.common.service.ServiceException;
...
import com.ai.ecs.modules.sys.dao.MenuDao;
import com.ai.ecs.modules.sys.dao.RoleDao;
import com.ai.ecs.modules.sys.dao.UserDao;
...
import com.ai.ecs.modules.sys.security.SystemAuthorizingRealm;
import com.ai.ecs.modules.sys.utils.LogUtils;
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public List<Menu> selectMenuByDesc(Menu menu){
		return menuDao.selectMenuByDesc(menu);
	}
	...
	public List<Menu> findAdminAllMenu(){
		return UserUtils.getAdminMenuList();
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By http://ecsite.com\r\n");
		sb.append("\r\n======================================================================\r\n");
