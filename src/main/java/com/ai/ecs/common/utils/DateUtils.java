...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	 ...
	 * @return
	 */
	public static long pastDays(Date date1,Date date2) {
		long t = date1.getTime()-date1.getTime();
		return t/(24*60*60*1000);
	}
	 ...
	 * @return
	 */
	public static Date changeDate(Date date , Integer integer) {
...
//		System.out.println(time/(24*60*60*1000));
		...
		System.out.println(changeDate(new Date(),60));
	}
}
