<%@ page contentType="text/html;charset=UTF-8" %><meta http-equiv="Content-Type" content="text/html;charset=utf-8" /><meta name="author" content="http://ecsite.com/"/>
...
<link href="${ctxStatic}/common/ecsite.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common/ecsite.js" type="text/javascript"></script>
